...
STRINGS = {
    "en": {
        ...
        "leave_confirm": "Leave this group? You can rejoin later.",
        ...
        "join_hint": "You only need the access code to join a private group.",
        "public_no_code": "Public groups can be joined with just their name.",
        "admin_group_public": "Admin-created groups are public and joinable by name.",
        "no_public_groups": "No public groups yet.",
        "user_manual": "User manual",
        "manual_food": "🥗 Add your meals and calories (or an amount) to each day; set your own category limits under Diet Limits.",
        "manual_budget": "💰 Log each expense with amount and category, set a limit for day/week/month, and watch your running total.",
        "manual_calendar": "📅 The calendar colours each day green (within limits), red (over) or grey (no entries); click a day to add or edit.",
        "manual_streaks": "🔥 Log days in a row to build day / week / month streaks. Score = day + week × 7 + month × 30.",
        "manual_groups": "🏆 Create a group; make it private (name + access code) or public (name only), then members join by name and are ranked by their diet score.",
        "manual_group_owner": "👑 The owner can rename the group, change its access code (private groups), promote/demote owners, kick members, view members' shared records, and delete the group. An owner can always delete the group they own; the admin can only delete the public groups it creates.",
        "manual_sharing": "🔒 When you join you choose what the owner may view of your records (diet, budget, or both); you can change it anytime under Sharing.",
        "manual_storage": "🗃️ Up to 60 days are stored per user; when full, newer days are blocked until you delete the oldest. Streaks are preserved across deletions.",
        "manual_admin": "🛡️ Admin can reset passwords, add/delete accounts, rename usernames, and manage public groups. Private group membership and member data are never shown to the admin.",
        "sharing": "Sharing",
        "share_with_owner": "Share with the group owner",
        "share_both": "Diet + Budget",
        "update_sharing": "Update sharing",
        "sharing_updated": "Sharing updated.",
        "sharing_info": "Choose what the group owner may view of your records — you can change this anytime.",
        "shares_diet": "Shares: Diet",
        "shares_budget": "Shares: Budget",
        "shares_both": "Shares: Diet + Budget",
        "shares_none": "Shares: nothing",
        "permission_not_granted": "Permission not granted",
        "diet_limits": "Diet limits",
    ...
    "zh": {
        ...
        "private_group": "私人群組",
        "public_group": "公開群組",
        "join_hint": "只有私人群組才需要存取碼。",
        "public_no_code": "公開群組只需名稱即可加入。",
        "admin_group_public": "管理員建立的群組為公開群組，只需名稱即可加入。",
        "no_public_groups": "尚無公開群組。",
        "user_manual": "使用手冊",
        "manual_food": "🥗 每天記錄餐點與卡路里（或份量）；可在「飲食限制」自訂各類別限制。",
        "manual_budget": "💰 記錄每一筆花費的金額與類別，設定每日／每週／每月預算上限，並隨時查看累計總額。",
        "manual_calendar": "📅 日曆會以綠色（達標）、紅色（超標）或灰色（無記錄）標示每一天；點選日期即可新增或編輯。",
        "manual_streaks": "🔥 連續記錄天數可累積日／週／月連續紀錄。分數 = 日 + 週 × 7 + 月 × 30。",
        "manual_groups": "🏆 建立群組：可設為私人（名稱＋存取碼）或公開（只需名稱），成員按名稱加入並依飲食分數排名。",
        "manual_group_owner": "👑 擁有者可以改名、更改存取碼（私人群組）、提升／取消共同擁有者、踢除成員、查看成員分享的記錄，並可刪除自己擁有的群組；管理員只能刪除它建立的公開群組。",
        "manual_sharing": "🔒 加入時可選擇允許群組擁有者查看的內容（飲食、預算或兩者）；之後隨時可在「分享設定」更改。",
        "manual_storage": "🗃️ 每位用戶最多儲存 60 天資料；空間滿時需先刪除最舊資料才能新增，刪除不會中斷連續紀錄。",
        "manual_admin": "🛡️ 管理員可重設密碼、新增／刪除帳號、更改用戶名、管理公開群組；私人群組的成員名單與成員資料一律不會顯示給管理員。",
        "sharing": "分享設定",
        "share_with_owner": "與群組擁有者分享",
        "share_both": "飲食＋預算",
        "update_sharing": "更新分享設定",
        "sharing_updated": "分享設定已更新。",
        "sharing_info": "選擇你允許群組擁有者查看的內容——隨時可以更改。",
        "shares_diet": "分享：飲食",
        "shares_budget": "分享：預算",
        "shares_both": "分享：飲食＋預算",
        "shares_none": "分享：無",
        "permission_not_granted": "未獲授權查看",
        "diet_limits": "飲食限制",
        "budget_limits": "預算限制",
        "limit": "限制",
